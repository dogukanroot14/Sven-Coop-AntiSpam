...
void PluginInit(){
	g_Module.ScriptInfo.SetAuthor( "root" );
	g_Module.ScriptInfo.SetContactInfo( "github.com/dogukanroot14" );
...
HookReturnCode ClientSaySpamo(SayParameters@ pParams){
  ...
  str2.ToUppercase();
	...
	if (pData.m_muteTime > g_Engine.time){
		...
		string aStr = "Spam Durdurucu: Susturulma bitme suresi: "+seconds+"."+secDiv10+"s.\n";
  ...
  if (
	...
	if(muteScore>250.0){
		...
		string msg = "Spam Durdurucu: "+pPlayer.pev.netname+" 1 dakika susturuldu.\n";
		...
		if (pData.m_warnTime == -1.0){
			...
			string msg = "Spam Durdurucu: Lutfen sunucuda spam yapmayiniz.\n";
			g_Game.AlertMessage( at_logged, msg );
			...
			string msg = "Spam Durdurucu: "+pPlayer.pev.netname+" 30 saniye susturuldu.\n";
			g_Game.AlertMessage( at_logged, msg );
			g_PlayerFuncs.ClientPrintAll( HUD_PRINTTALK, msg );
